  ...
  return (
    <header className="z-10 flex h-[60px] shrink-0 items-center justify-between border-b border-white/[0.06] bg-ink-950/60 px-6 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-1.5">
        <button className="relative flex h-9 w-9 items-center justify-center rounded-xl text-zinc-400 transition-colors hover:bg-white/5 hover:text-zinc-100">
          <Bell size={17} />
          <span className="absolute right-2.5 top-2.5 h-1.5 w-1.5 rounded-full bg-primary-500 shadow-glow-sm" />
        </button>

        <div className="mx-1 h-5 w-px bg-white/10" />

        <div className="flex items-center gap-2.5 rounded-xl py-1.5 pl-1 pr-2">
